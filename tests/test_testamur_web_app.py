...
class TestamurCanonicalWebTest(unittest.TestCase):
    ...
    def test_static_surface_is_packaged_under_testamur_namespace(self) -> None:
        ...
        self.assertIn("Install integrations", app)
        self.assertIn("No plugin monitor providers registered", app)
        self.assertIn("manifest declaration ≠ runtime use", app)
        self.assertIn(".provider-discovery", styles)
        self.assertIn(".environment-integration-strip", styles)
